<?php
    ...
    switch($_GET["opcion"]){
        ...
        case "insert":
            $datos = $inicio->insert_producto($body["hoyText"],$body["enterateImg"],$body["carruselImg"],$body["carruselImg2"],$body["carruselImg3"],$body["hoyImg"]);// id de la tablab a consultar
            echo json_encode("Producto Insertado");
            break;
        
        //Para actualizar un registro se debe mandar los campos en el json
        case "update":
            $datos = $inicio->update_producto($body["id"], $body["hoyText"],$body["enterateImg"],$body["carruselImg"],$body["carruselImg2"],$body["carruselImg3"],$body["hoyImg"]);// id de la tablab a consultar
        ...
        case "kill":
            ...
            $datos = $inicio->kill_producto($body["id"]);// id de la tablab a consultar
